        ...
        AgentTool(
            ...
            inputSchema: objectSchema(
                properties: [
                    ...
                    "aspectRatio": ["type": "string", "description": "Required output aspect ratio. Pass the user's requested value exactly as listed by list_models (e.g. '16:9', '9:16')."],
